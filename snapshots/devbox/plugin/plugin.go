...
import (
	...
	"github.com/containerd/containerd/snapshots/devbox"
...
func init() {
	plugin.Register(&plugin.Registration{
		...
		InitFn: func(ic *plugin.InitContext) (any, error) {
			...
			var oOpts []devbox.Opt
			if config.UpperdirLabel {
				oOpts = append(oOpts, devbox.WithUpperdirLabel)
			}
			if !config.SyncRemove {
				oOpts = append(oOpts, devbox.AsynchronousRemove)
			}
